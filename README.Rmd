...
[gnuplots](http://www.gnuplot.info/), which may be helpful if you use both of
them in one project.
...
ggnuplot features inward ticks, secondary axes, and labels on the plot corners.
It also comes with gnuplot's default color palette. This is what it looks like:
